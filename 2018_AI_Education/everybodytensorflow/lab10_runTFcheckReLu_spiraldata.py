...
with tf.Session() as sess:
    ...
    for epoch in range(training_epochs):
        ...
        if display_step == 0:
            ...
            errRatebyTrainingSet[epoch] = 1.0 - accuracy.eval({X: batch_train_xs, Y: batch_train_ys}, session=sess)
            
            errRatebyValidationSet[epoch] = 1.0 - accuracy.eval({X: batch_valid_xs, Y: batch_valid_ys}, session=sess)
