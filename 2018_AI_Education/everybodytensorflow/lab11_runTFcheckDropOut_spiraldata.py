...
def neural_net(x, dropoutrate_io):
    ...
    # layer_1 = tf.nn.dropout(inputs=layer_1, keep_prob=dropoutrate_io)
...
# Construct model
logits = neural_net(x=X, dropoutrate_io=dropoutrate_io)
